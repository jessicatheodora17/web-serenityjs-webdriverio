...
export const config: WebdriverIOConfig = {
    user: 'oauth-jessica.novia-769b3',
    key: 'e0e3ab2f-e57b-4465-b1d3-4a80ff3af252',
    specs: [
        './features/*.feature'
    ],
    exclude: [
    ...
    capabilities: [{
        ...
        'sauce:options': {
            tunnelIdentifier: 'oauth-jessica.novia-769b3_tunnel_name',
            // Example options
            build: 'atweb sicepatfood',
            // screenResolution: '1600x1200',
            // ...
        }
    }],
    logLevel: 'info',
    baseUrl: 'https://internal.s.sicepatfood.com',
    bail: 0,
